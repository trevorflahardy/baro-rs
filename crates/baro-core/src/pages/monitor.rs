...
//!
//! This was previously the "Settings" page. It has been moved here
//! so the Settings page can become a category-list navigation hub.
...
impl MonitorPage {
    ...
    pub fn init(&mut self) {
        ...
        self.title_idx = self
            .container
            .add_child(
                Element::text(hint, "Monitor", TextSize::Large),
